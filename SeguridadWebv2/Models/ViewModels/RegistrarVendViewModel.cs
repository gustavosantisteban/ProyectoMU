...
{
    public class RegistrarVendViewModel
    {
        [Required]
        [EmailAddress]
        [Display(Name = "Email")]
        ...
        [StringLength(10, ErrorMessage = "La altura de la calle del asociado no puede contener mas de 10 caracteres")]
        [Display(Name = "Altura:")]
    ...
    public class EditarVendViewModel
    {
